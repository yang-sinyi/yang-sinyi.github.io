...
(function($) {
	...
	/*------------------
		Portfolio Page
	--------------------*/
	$('.portfolio1 a').on('click', function(e){
		$(this).closest('.portfolio1').toggleClass('open');
	  });

	$('.portfolio2 a').on('click', function(e){
		$(this).closest('.portfolio2').toggleClass('open');
	  });

	$('.portfolio3 a').on('click', function(e){
		$(this).closest('.portfolio3').toggleClass('open');
	  });

	$('.portfolio4 a').on('click', function(e){
		$(this).closest('.portfolio4').toggleClass('open');
	  });

	$('.portfolio5 a').on('click', function(e){
		$(this).closest('.portfolio5').toggleClass('open');
	  });
